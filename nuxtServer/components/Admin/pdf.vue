                ...
                <div class="name-job-desc">
                  <div class="header row">
                    <div style="display: flex !important;align-items: center !important;" class="col-6">
                      ...
                      <div class="user-image" :style="{ borderColor : activeColor}" v-else style="background-image: url(~/assets/images/company/no-photo.jpg);"></div>
                              ...
                              <li style="margin-top: 30px;" v-for="(item , index ) in result.languages" :key="index">
                                ...
                                <span v-if="item.read">
                                                    ...
                                                    <label class="grade">
                                                        ...
                                                        <i v-for="(item , index) in parseInt(5 - item.read)"></i>
                                                    </label>
                                                </span>
                                <span v-if="item.say">
                                                    <label
