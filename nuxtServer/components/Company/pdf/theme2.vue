<template>
  <div class="body-pdf">
    <div class="my-2">
      <div class="row">
        <div class="col-12" >
          <div slot="pdf-content" ref="content" id="content" class="karavel-box">
              ...
              <div class="contact-info col-12">
                <div class="name-job-desc">
                  <div class="header row py-0">
                    <div style="padding-top : 60px ; padding-bottom :20px;background: #e8e8e8" class="col-md-4 d-flex align-items-center flex-column">
                      ...
                      <div style="margin-right: 10px;" class="">
                        <h1 class="mt-3" :style="{ color: activeColor , fontSize : titleSize}">{{ result.name }}
                          {{ result.last_name }}</h1>
                      </div>
                    ...
                    <div class=" total-info col-md-8 d-flex align-items-center">
                      <div :style="{ color: activeColor  , fontSize : subtitleSize}" class="other-infos not-drag">
                        ...
                        <div class="basic_job" v-if="result.job" :style="{ fontSize : subtitleSize}">
                          <span>  تخصص </span>
                          <span> : </span>
                          <span>{{ result.job.title }}</span>
                          <span>( {{ result.cat.title }} )</span>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div class="property-item_body contact">
                          <div class="infoo info">
                            ...
                            <div class="contact-item contact__city d-flex" v-if="result.province || result.city "
                              ...
                              <span dir="rtl" >
                                  <div v-if="result.province" style="display: inline">  {{ result.province.title }} - </div>
                                  <div v-if="result.city" style="display: inline">  {{ result.city.title }} - </div>
                                  <div style="display: inline">  {{ result.address }}  </div>
                              </span>
                            </div>
                          </div>
                        </div>
                            ...
                            <li class="mb-3" v-for="(item , index ) in result.record_studies" :key="index">
                              <div style="margin-right: 0;margin-left: 0;" class="row">
                                ...
                                <div style="padding-right: 0px;padding-left: 0px;" class="col-6 col-md-3 box-m">
                                  <label class="date" style="direction: ltr" :style="{fontSize : textSize}" v-if="item.Studying == 1">  از سال {{ item.entering_year }}  تا کنون </label>
