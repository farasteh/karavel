<template>
  <div class="body-pdf" style="width: 100%; margin-top : -10px">
    <div class="mt-2" style="width: 330mm ;margin: auto ; background: rgb(45 45 45);">
      <div>
        <div class="row">
          ...
          <div class="col-8 mb-2 mt-4 centerd-box" >
            <div class="row" >
              <div class="col-12 d-flex justify-content-center mb-2" >
                <nuxt-link :to="{path  : '/member/resume'}">
                  <Icon type="md-close"  class="close-pdf"/>
                </nuxt-link>
              </div>
              <div class="col-6 pl-1">
                <button @click="setDefault" class="btn-pdf p-4 karavel-btn">
                  تنظیمات پیشفرض
                </button>
              </div>
              <div class="col-6 pr-1">
                <button @click="createPDF" class="btn-pdf p-4 karavel-btn">
                ...
                <div class="contact-info col-12">
                  <div class="name-job-desc">
                    <div class="header row py-0">
                      <div style="padding-top : 60px ; padding-bottom :20px;background: #e8e8e8" class="col-4 d-flex align-items-center">
                        <div class="user-image" v-if="result.image" :style="{borderColor : activeColor , backgroundImage: 'url('+ appUrl+'/images/company/' + result.image + ')'}"></div>
                      ...
                      <div style="padding-top : 60px ; padding-bottom :20px" class="col-8 d-flex align-items-center">
                    ...
                    <div class="row">
                              ...
                              <ul class="history">
                                <li style="margin-top: 30px;" v-for="(item , index ) in result.languages" :key="index">
                                  ...
                                  <span v-if="item.say">
                                                        ...
                                                        <label class="grade">
                                                            <i v-for="item in parseInt(item.say)" class="tik"
                                                               :style="{ background: labelColor}"></i>
                                                            <i v-for="item in 5 - parseInt(item.say)"></i>
                                                        </label>
                                                   </span>
                                  <span v-if="item.listen">
                                                        ...
                                                        <label class="grade">
                                                            <i v-for="item in parseInt(item.listen)" class="tik"
                                                               :style="{ background: labelColor}"></i>
                                                            <i v-for="item in 5 - parseInt(item.listen)"></i>
                                                        </label>
                                                    </span>
                      ...
                      <div class="col-12 col-md-8 lgbox col-wide sortable-cv-items">
                        <div class="property-item basic__about" v-if="result.comment">
                          ...
                          <div class="property-item_body" style="direction: rtl">
                              ...
                              <li class="mb-3" v-for="(item , index ) in result.record_studies" :key="index">
                                <div style="margin-right: 0;margin-left: 0;" class="row">
                                  ...
                                  <div style="padding-right: 0px;padding-left: 0px;" class="col-3 box-m">
                                    <label style="direction: ltr" class="date" :style="{fontSize : textSize}" v-if="item.Studying == 1">{{ item.entering_year }} آغار از سال </label>
                              ...
                              <li style="margin-bottom: 20px !important;margin-top: 17px" class="mb-3" v-for="(item , index ) in result.record_jobs" :key="index">
                                <div style="margin-right: 0px;margin-left: 0px;align-items: center;" class="row">
                                  ...
                                  <div style="padding-left: 0px;padding-right: 0px" class="col-3 box-m">
                                    ...
                                    <label style="direction: ltr" class="date" :style="{ fontSize : textSize}" v-if="item.start && !item.end">
                  ...
                  <div class="text-center text-white" style="background: var(--var-background-color)">
          <h5 class="font-14 mb-0 py-1" style="padding: 5px 0">ایجاد شده توسط وبسایت کاراول -
            <a class="site-link" href="https://karavel.ir" target="_blank">karavel.ir</a></h5>
        </div>
              </div>
            </div>
...
export default {
  ...
  data() {
    return {
      ...
      swatches: [
        ...
        ['#0765bd', '#3a72cd', '#5b94e7', '#6facf1', '#83AFEAFF'],
  ...
  computed: {
    ...
    result() {
      return this.$store.state.Member.Resume.BaseResume.result
    },
    birthDate() {
  ...
  created() {
    this.$store.dispatch('Member/Resume/BaseResume/LoadReultResume');
    this.getPdf();
  },
  ...
  methods: {
    ...
    setDefault () {
      this.activeColor = '#0765bd'
      this.labelColor = '#F891A6'
      this.leftBOxColor =  '#ee7057'
    ...
    saveChanges() {
      ...
      return new Promise((resolve, reject) => {
        this.$axios.post('api/v1/member/pdfChanges', form)
          .then(success => {
    ...
    getPdf() {
      ...
      this.$axios.post('api/v1/member/getPdf', form)
        .then(res => {
