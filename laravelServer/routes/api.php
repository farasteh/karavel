...
Route::prefix('v1')->namespace('App\Http\Controllers\v1')->group(function (){
    ...
    Route::post('/UploadBanner', 'Upload\UploadController@UploadBanner');
...
//    Route::apiResource('/user/advertising', 'User\AdvertisingController');
        ...
        Route::get('/user/advertising/city/{id}', 'Site\AdvertisingController@getByCity');

        //staff routes
        Route::post('/user/staff/get', 'Site\StaffController@index');
        Route::get('/user/staff/getSame/{staff}', 'Site\StaffController@getSimailar');
        ...
        Route::group( [ 'middleware' => [ 'verifyAccess' , 'auth:api', 'scope:Company' ] ], function () {
            ...
            Route::post('site/company/send-request/{company}/{BaseResume}' , 'Site\StaffController@store');
            Route::get('company/staff/requests' , 'Company\Staff\resumeController@getResumeRequest');
        });
        ...
        Route::group( [ 'middleware' => [ 'auth:api', 'scope:Admin' ] ], function () {
            ...
            Route::post('/admin/resume/remindSMS' , 'Admin\User\BaseResumeController@remindResumeSMS');
        ...
        Route::group( [ 'middleware' => [ 'auth:api', 'scope:Member'] ], function () {
            ...
            Route::put('member/resume-base/contact/change' , 'Member\Resume\BaseController@disableContacts');
            Route::put('member/resume-base/sms/change' , 'Member\Resume\BaseController@disableSms');
            ...
            Route::get('member/company' , 'Member\CompanyRequest\CompanyController@getCompanies');
        });
  //  });
