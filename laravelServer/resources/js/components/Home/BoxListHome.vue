<template>
    <div class="col-md-6 mt-4">
        <div class="box-list-date-home">
            ...
            <router-link :to="{name: 'SiteShowJobIndex', params: {id: advertising.id}}" class="w-75">
            ...
            <div class="mt-2 data-list-box">
                ...
                <router-link v-else :to="{name: 'SiteShowJobIndex', params: {id: advertising.id}}" class="link-list-resume" >
