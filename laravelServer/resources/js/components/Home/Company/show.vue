            ...
            <div class="col-12 p-0 d-flex">
                ...
                <div class="left-box-board" >
                    <div v-if="memberRole == 'Member' &&
                            $store.getters.SitememberSentResume(List.id , User.member.id)">
                        <p>
                            رزومه ارسال شده
...
export default {
    ...
    methods : {
        ...
        liked() {
            ...
            {
                this.$store.dispatch('SiteLikeAdvertising' , {id : this.List.id , member : this.User.member.id})
            }
        ...
        disliked () {
            this.$store.dispatch('SitedislikeAdvertising' , {id : this.List.id , member : this.User.member.id})
                .then(success => {
                    console.log(success)
                }).catch(err => {
                console.log(err)
    ...
    computed :  {
        ...
        like() {
            if(this.User && this.List)
                if(this.memberRole == 'Member')
                    return this.$store.getters.SiteLikedUsersList(this.List.id , this.User.member.id)
        },
        pathName() {
