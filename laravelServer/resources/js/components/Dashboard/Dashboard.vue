    ...
    <div>
        <div>
            <div>
                <div class="row">
                    <div class=" col-6 ">
                        <h2 class="panel-title">لیست آگهی های فعال </h2>
                    </div>
                    <div class=" col-6 ">
                    ...
                    <div class="col-12 col-md-5 mt-3" >
                        <Input class="search-ads" size="large" v-model="search" search enter-button placeholder="جستجو در عنوان آگهی" />
                    </div>
                </div>
...
<script>
import AdvertisingsBox from '../Dashboard/box.vue';
...
import vSelect from 'vue-select'
  ...
  export default {
      ...
      created() {
          ...
          this.$store.dispatch('LoadCompanyAdvertizing')
            .then(res => {
                this.loading = false
            })
      } ,
      computed : {
          ...
          AdvertisingsBoxList() { return  this.$store.getters.selectedJobsAds(this.jobSelected , this.search)},
      } ,
      watch :{
          User () {
