            ...
            <div >
               ...
               <div class="box-advertizing">
                   <div class="row">
                       <div class="col-md-2 d-flex align-items-center justify-content-center" v-if="Advertizing.Company">
                            <img v-if="ErrorImage" class="box-log" :alt="Advertizing.Company.name_fa"
                             src="/images/company/no-company.png" >
                   ...
                   <div class="text-center">
                       <span style="cursor: pointer; margin:10px 0" @click="myFilter()">شرح شغل </span>
                   </div>
               </div>
            </div>
...
export default {
    ...
    created ( ) {
        this.$store.dispatch('LoadMemberAdvertizingSingle' , {id  : this.$route.params.id})
        this.$store.dispatch('LoadStatus');
    } ,
    computed : {
        Advertizing() { return this.$store.state.MemberAds.memberAdvertizing},
